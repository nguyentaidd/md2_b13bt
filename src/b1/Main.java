...
//Tìm chuỗi tăng dần có độ dài lớn nhất
        for (int i = 0; i < string.length(); i++) {//vòng lặp bên ngoài
            //Khai báo một LinkedList trung gian các kí tự chuỗi tăng dần
            LinkedList<Character> list = new LinkedList<>();
            //thêm kí tự thứ i vào trong list
            list.add(string.charAt(i));
            for (int j = i+1; j <string.length() ; j++) {//vòng trong
            ...
            //So sánh kích cỡ list trung gian và list chứa chuỗi tăng dần có kích thước lớn nhất
